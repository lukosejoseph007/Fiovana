...
const App: React.FC = () => {
  ...
  const setDroppedFiles = useCallback((newFiles: FileInfo[] | ((prev: FileInfo[]) => FileInfo[])) => {
  ...
  useEffect(() => {
    const handleGlobalDrop = (e: DragEvent) => {
      const dropZone = (e.target as Element)?.closest('[aria-label="Drop files here or click to browse"]')
            ...
            <section className="text-center py-12">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Drag and drop files into the drop zone above, or click to browse and select files from your computer.
                </p>
              </div>
            </section>
          )}
