  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div>
        ...
        <div style={{ fontSize: '12px', color: '#a8a8a8' }}>3 recommendations</div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#00d4ff', cursor: 'pointer' }}>View all...</div>
        </div>
      </div>
      ...
      <div>
        ...
        <Card variant="default" padding="md">
          ...
          <div style={{ fontSize: '12px', color: '#a8a8a8', marginBottom: '8px' }}>
            24 concepts identified
            <br />
            12 procedures mapped
            <br />3 gaps detected
          </div>
