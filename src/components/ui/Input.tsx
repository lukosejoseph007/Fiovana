  ...
  (
    ...
    const sizeStyles = {
      sm: {
        ...
        padding:
          leftIcon || leftAddon
            ? `0 ${designTokens.spacing[3]} 0 ${designTokens.spacing[8]}`
            : rightIcon || rightAddon
              ? `0 ${designTokens.spacing[8]} 0 ${designTokens.spacing[3]}`
      ...
      md: {
        ...
        padding:
          leftIcon || leftAddon
            ? `0 ${designTokens.spacing[4]} 0 ${designTokens.spacing[10]}`
            : rightIcon || rightAddon
              ? `0 ${designTokens.spacing[10]} 0 ${designTokens.spacing[4]}`
      ...
      lg: {
        ...
        padding:
          leftIcon || leftAddon
            ? `0 ${designTokens.spacing[5]} 0 ${designTokens.spacing[12]}`
            : rightIcon || rightAddon
              ? `0 ${designTokens.spacing[12]} 0 ${designTokens.spacing[5]}`
